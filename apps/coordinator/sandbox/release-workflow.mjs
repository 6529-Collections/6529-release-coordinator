// The generated sandbox release workflow. provision-release.mjs publishes it
// verbatim to both test repositories, and release-runtime-config.mjs pins its
// git blob, so the offline runtime-config test can hash this exact text.
export const releaseWorkflow = `name: Sandbox release
