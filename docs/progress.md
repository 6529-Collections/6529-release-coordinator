...
a new filtered run while its lock remains. Record the actual real staging
result separately; successful trial checks are not staging proof. A production
ticket is separate and follows staging acceptance.
