...
merged with offline coverage, and the sandbox workflow lock now models the real
per-environment deploy locks; the live sandbox proof of the wait is the next
sandbox step.
