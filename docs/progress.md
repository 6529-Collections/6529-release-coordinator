...
| Real-profile release adapter        | PR #218 selects product repositories under `RELEASE_COORDINATOR_PROFILE=real` and uses the shared release engine with existing product workflows.                                                                                                   | PR #218 merged, but its monitoring dispatch contract remains incompatible with the product backend until PR #219 merges. The correction has offline tests plus sandbox success and recovery evidence, not product execution proof. No product PR, merge, deploy, rollback, or live E2E was performed. Database-changing failures never enter automatic recovery; manual release remains the proven path.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
Coordinator [PR #219](https://github.com/6529-Collections/6529-release-coordinator/pull/219)
plans staging monitoring on `1a-staging` and production monitoring on `main`,
...
checks passed; 6529bot found no blocking issue. PR #219 remains unmerged.
...
waits for the exact job set without redispatching. Next, merge PR #219 after
...
correction is still on open Coordinator PR #219. The environment-ref guard around workflow dispatch from PR #172 was
