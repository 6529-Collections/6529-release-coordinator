...
`1791f94` ([PR #218](https://github.com/6529-Collections/6529-release-coordinator/pull/218)).
...
| Product-shaped test workflow mirror | Merged test frontend and backend workflows build only sample code and publish fake deployment evidence while mirroring most real workflow filenames, inputs, branch rules, concurrency groups, deploy job names and deploy-to-E2E run linking; published monitoring remains the known contract exception; a local correction awaits delivery                                                                                                                  | Frontend test [PR #92](https://github.com/6529-Collections/release-coordinator-test-frontend/pull/92) merged at `42a2a5f`; backend test [PR #100](https://github.com/6529-Collections/release-coordinator-test-backend/pull/100) merged at `7565898`. Protected staging publication and the complete staging/production success path passed [September 21 live acceptance](./testing/product-shaped-workflow-mirror-2026-09-21.md), including exact deploy-to-E2E linking, backend service dispatches, monitoring from test `main` and downloaded evidence readback.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
The local code correction now plans staging monitoring on `1a-staging` and
production monitoring on `main`, sends only the existing `environment` input,
