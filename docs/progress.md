...
| Real releases | Existing product release procedures remain in use; the frontend product workflow has an exact-source guard | Coordinator staging/production execution, source-guard enforcement, authorization and rollback are not built. |
